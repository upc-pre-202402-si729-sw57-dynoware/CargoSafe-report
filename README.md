...
| Mi nombre es Carlos Andres Leon Rioja, tengo 21 soy estudiante de la carrera de Ingeniería de software. Me gusta todo lo que tenga que ver con la ciencia y tecnología. Tengo conocimientos en los lenguajes de programacion C++, C#, Python, Java, JavaScript, Lua, PHP y Kotlin ademas de conocimientos en HTML, CSS y en los frameworks de Vue, Angular y Flutter. Me considero una persona amable, autodidacta y responsable.    |  ![Integrante_Carlos](assets/chapter-1/Integrante_Carlos.png)  |
