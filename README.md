...
|4\.3|12/11/2024|Astrid Boronda|Agregar preguntas en la sección de Diseño de Entrevistas|
|4\.4|13/11/2024|Astrid Boronda|Agregar las evaluaciones de acuerdo a las heurísticas|
|4\.5|18/11/2024|Astrid Boronda|Sprint Backlog 4 y Sprint Planning|
|4\.6|18/11/2024|Ely Cortez|Execution Evidence for Sprint Review|
|4\.7|18/11/2024|Carlos Leon|Services Documentation Evidence for Sprint Review|
|4\.8|18/11/2024|Alexandra Ramos|Collaboration insights y Sprint Planning|
|4\.9|18/11/2024|Renzo Silva|Software Deployment Evidence for Sprint Review|
|5\.0|19/11/2024|Astrid Boronda|Team Collaboration Insights during Sprint|
|5\.3|19/11/2024|Alexandra Ramos|Testing Suite Evidence for Sprint Review|
...
| :-: | :-: | :-: |
|Comunica oralmente con efectividad a diferentes rangos de audiencia.|<p>Astrid Boronda<br>TB1: En esta entrega se realizaron los diagramas C4, diagramas involucrados en el proceso de DDD o Domain Driven Design. Una característica de esta metodología es el uso del lenguaje ubicuo que fue determinado dentro de nuestro equipo en una de nuestras reuniones. Permite a todos los stakeholders internos y externos del proyecto entender detalles técnicos a un alto nivel mediante la visualización de los diagramas. Además, pudimos comunicar nuestras ideas con personas conocedoras del tema para asegurarnos de desarrollar un buen enfoque y presentar un producto agradable tanto para emprendedores como transportistas.<br>TP1:</p><p>Para esta entrega logré comunicar mis ideas con respecto a la colaboración dentro del repositorio de la organización. Logrando avisar a mis compañeros si iba a realizar algún cambio o si iba con respecto al desarrollo del componente de la aplicación web. Finalmente, comuniqué periódicamente mis avances mediante las reuniones semanales logrando un mejor flujo de trabajo de equipo.<br><br>Ely Cortez<br>TB1: Logré comunicar mis ideas con respecto al diseño de la Landing Page para lograr agradar al usuario visitante. Además, realice la sección de header en el landing page, además de su correspondiente código en JavaScript para cumplir funcionalidades. Adicionalmente, se encargó de documentar los commits realizados por el equipo siempre comentándoles mis avances.<br>TP1: Durante el desarrollo de este sprint, consideré que la comunicación era indispensable, ya que se debía presentarla interfaz con componentes para las vistas de los segmentos objetivos. A través de reuniones semanales logré expresar mi avance y como cumplía con las actividades para este sprint.</p><p>TB2: En el desarrollo de la TB2, me centré en fortalecer la comunicación con el equipo. Dado que tanto el backend como el frontend requieren tiempo, resultó clave mantener actualizados tanto mis avances como los de mis compañeros. Una comunicación efectiva nos permitió organizar mejor los commits y prevenir posibles conflictos o divergencias entre las ramas en el futuro.</p><p>TF1:<br>Contribuyó significativamente al rediseño de la landing page, asegurando una experiencia más accesible y funcional para los usuarios. Propuso soluciones innovadoras para optimizar el rendimiento visual e interactivo de la página. Además, trabajó en la integración de componentes interactivos, garantizando que las conexiones entre las distintas partes del sistema se mantuvieran estables y funcionales. También se aseguró de que las APIs cumplieran con los estándares de validación de datos, documentando cada proceso con claridad. En las presentaciones grupales, Destacó por explicar de manera efectiva cómo estos cambios impactaron positivamente en la experiencia del usuario, logrando comunicar tanto los detalles técnicos como su relevancia práctica.</p><p></p><p>Alexandra Ramos<br>TB1: Además, creé esquemas narrativos y diagramas de casos de uso que ayudaron a ilustrar las posibles interacciones de los usuarios con la aplicación. Estos materiales no solo facilitaron la comprensión del equipo, sino que también sirvieron como referencia para la toma de decisiones durante las etapas de diseño y desarrollo.<br>TP1: Durante el desarrollo de la interfaz de usuario de nuestro producto de software, me centré en comunicar de manera precisa y completa los avances y resultados logrados a lo largo del proyecto. A través de actualizaciones constantes, compartí el progreso en el diseño e implementación de los distintos componentes, subrayando los aspectos más importantes y las implicaciones técnicas correspondientes.</p><p>TF1:</p><p>Implemento un diseño consistente y adaptativo para todos los dispositivos. También colaboró estrechamente en la configuración de los flujos de datos, asegurándose de que la información se procesara correctamente desde la interfaz hasta el sistema de almacenamiento. Gracias a su capacidad de comunicación, tanto en reportes técnicos como en las discusiones grupales, logró transmitir con claridad el impacto de estas mejoras, motivando al equipo a alcanzar altos estándares de calidad.</p><p><br>Renzo Silva<br>TB1: Se comunicaron las herramientas a utilizar, su utilidad y las convenciones típicas, esto con el objetivo de documentar el proceso de elaboración y de explicar a un público ajeno al entorno de desarrollo de software los pasos necesarios para diseñar a la aplicación.<br>TP1: Para este entregable, logré comunicar de manera clara y objetiva mi progreso con el desarrollo de los componentes asignados. Además, pude comunicarme con mis compañeros y con la audiencia para recibir alguna recomendación con respecto al diseño.</p><p>TF1:</p><p>Se destacó por su atención al detalle en cada etapa del proyecto, identificando y solucionando problemas clave en el rendimiento de la landing page. En cuanto a comunicación escrita, redactó reportes que documentaban los problemas encontrados, como tiempos de carga excesivos o errores en la validación de datos, y detalló las soluciones implementadas. Su capacidad para presentar estos hallazgos de manera clara y estructurada ayudó al equipo a priorizar las mejoras necesarias.</p><p></p><p>Carlos Leon</p><p>TB2: Para esta entrega se realizo reuniones para coordinar los ultimos detalles del front end y definir como empezar a desarrolar el back end y donde desplegarlo.</p><p>TF1:</p><p>Jugó un papel esencial en la coordinación de las mejoras técnicas del proyecto, asegurándose de que cada aspecto del diseño y desarrollo estuviera alineado con los objetivos generales. Creó documentos técnicos claros que describían los cambios en la interacción entre la landing page y los sistemas subyacentes, incluyendo los procesos de validación y manejo de datos.</p><p></p>|<p>TB1:</p><p>Desarrollamos las entrevistas necesarias para la validación de la idea de nuestro proyecto.</p><p>TP1:</p><p>Hemos desarrollado un video explicando el desarrollo progresivo del proyecto. Además, mediante la comunicación continúa, se ha logrado desarrolla r el frontend de la aplicación</p>|
|Comunica por escrito con efectividad a diferentes rangos de audiencia|<p>Astrid Boronda<br>TB1: Me enfoqué en realizar un análisis competitivo, identificando a los competidores y transmitiendo la información encontrada sobre sus ventajas competitiva mediante la redacción del informe. Estas ventajas se pueden aprovechar para el desarrollo del producto. De manera similar, utilicé herramientas como User Personas, Task Matrix y Empathy Map para conocer mejor a los segmentos objetivo.<br>TF1:</p><p>Documenté cómo las APIs interactuaban con el frontend, describiendo en detalle los procesos de validación y las conexiones necesarias. Este documento fue esencial para garantizar que todos los desarrolladores trabajaran bajo un entendimiento común. Contribuyó al informe final del proyecto, sintetizando los avances logrados en cada área. Mi capacidad para conectar los aspectos técnicos y visuales fue clave para reflejar el impacto del trabajo del equipo en los objetivos del proyecto.<br>Ely Cortez<br>TB1: Para este entregable la redacción de Historias de Usuario ayudó a comprender las características del software desde la perspectiva del usuario, permitiendo definir las funciones necesarias para la construcción de la aplicación. Estas historias permitieron establecer claramente qué funcionalidades eran prioritarias para satisfacer las necesidades del usuario final. Además, se complementó el análisis con la elaboración de un diagrama de clases, que ayudó a estructurar y organizar los componentes clave del sistema, mostrando las relaciones entre ellos y asegurando que la lógica del negocio estuviera bien definida desde una perspectiva técnica.<br>TP1: Logré realizar las correcciones respectivas en el informe. Mejorando la redacción de la User Stories y el Product Backlog. Esto nos permitió mejorar nuestra visión de desarrolló y comprender mejor lo que se busca para que cada segmento objetivo pueda tener una experiencia agradable al usar el producto final.</p><p><br>TB2: Durante el desarrollo de la TB2, asumí principalmente la responsabilidad del frontend, así como de la estructuración inicial del backend y de mi endpoint asignado. También llevé a cabo una entrevista dirigida al segmento objetivo de empresarios. En cuanto al backend, diseñé e implementé un bounded context aplicando los principios de Domain-Driven Design.</p><p>TF1: </p><p>Presenté las observaciones sobre la landing page, explicando de manera clara cómo las mejoras propuestas mejorarían la usabilidad y el rendimiento. Coordinó sesiones para revisar los avances en el frontend, explicando cómo se conectaban los nuevos componentes con las funcionalidades existentes y resolviendo dudas del equipo. En discusiones técnicas sobre el backend, utilicé diagramas de flujo y ejemplos prácticos para explicar cómo los datos se procesaban y almacenaban de manera eficiente.</p><p>Alexandra Ramos<br>TB1: Para el trabajo logré documentar el trabajo en un repositorio de GitHub de modo que se aprendió a utilizar conventional commits y gitflow de modo que se pueda tener una correcta comunicación escrita en lo que corresponde a la documentación del proyecto. Además, logré expresar de manera escrita las herramientas utilizar, las convenciones que debemos seguir, las configuraciones y el despliegue de la Landing Page.<br>TP1: Para la entrega del TP, previemnte, realicé las correcciones establecidas por el profesor. Realicé las mejoras correspondientes a las User Stories, elaboré el Impact Mapping y fui la responsable del Sprint Planning 2, garantizando que para el desarrollo de sprint el trabajo sea equitativo.<br>TF1:</p><p>Presenté los problemas encontrados en la landing page durante las reuniones iniciales, utilizando datos y ejemplos para respaldar sus observaciones. Explique cómo los componentes del frontend fueron ajustados para mejorar la interacción del usuario, utilizando simulaciones en vivo para mostrar los resultados. Durante las discusiones sobre el backend, explique cómo las validaciones implementadas garantizaban la integridad de los datos procesados por el sistema.</p><p></p><p><br>Renzo Silva<br>TB1: En la realización de este proyecto, consideré importante comprender la problemática que rodea la solución propuesta, tomando en cuenta los antecedentes que permitieran profundizar en el escenario y contexto. Esto me permitió implementar de manera escrita la propuesta y completar el proceso de Lean UX. Además, se delimitó el segmento objetivo afectado directamente por el problema. Utilicé la herramienta Lean UX Canvas para recopilar toda la información relevante y redactar una guía del proceso de desarrollo del producto.<br><br>TP1: Para esta entrega, me enfoqué en realizar las mejoras de acuerdo al feedback de la TB1. Esto me permitió redactar el Problem Statement de manera efectiva, siguiendo la estructura correcta. Además, logré redactar los Assumptions, teniendo en claro que las preguntas son de ayuda para definir cada aspecto del negocio.</p><p>TF1:</p><p>Moderé reuniones para revisar los avances en el frontend, asegurándose de que todos los miembros entendieran las funcionalidades implementadas. En discusiones técnicas sobre el backend, explique las validaciones aplicadas y cómo estas fortalecían la seguridad del sistema. Además, encargó de comunicar los logros del equipo de manera clara y estructurada, adaptando su mensaje al público presente.</p><p></p><p></p><p>Carlos Leon</p><p>TB2: Me encargue de desarrollar los end points para los Payment Cards y Companies ademas de juntar las diferentes ramas del back end y desplegarlo en Azure.</p><p></p><p>TF1:</p><p>Presente ejemplos prácticos de los componentes desarrollados, mostrando cómo los elementos visuales se adaptaban a diferentes dispositivos. Esto permitió al equipo visualizar los resultados de su trabajo en tiempo real. Durante las reuniones sobre el backend, detalle cómo las APIs procesaban las solicitudes y gestionaban las respuestas. Su capacidad para simplificar conceptos técnicos fue fundamental para garantizar la alineación del equipo. Expuse de manera clara cómo las mejoras en la landing page, el frontend y el backend impactaron en la funcionalidad general del sistema.</p><p></p>|<p>TB1:</p><p>Hemos desarrollado todo el primer paso para mostrar por primera vez nuestra Start Up y nuestra solución de Software. Desarrollamos todos los puntos necesarios, desde la descripción de la start up hasta los primeros mock-ups de la aplicación web que se piensa entregar al usuario final.</p><p>TP:</p><p>Desplegamos la primera versión de nuestra web site, aplicando todos los conocimientos adquiridos en clase. También, se realizaron cambios desde la entrega pasada para la entrega de un mejo</p>|
...
![](assets/chapter-4/logisdash.png)

![](assets/chapter-4/logisdash2.png)

![](assets/chapter-4/dashboard.png)

![](assets/chapter-4/dashboard2.png)
...
![](assets/chapter-4/myinfo.png)

![](assets/chapter-4/conductorinfo.png)
...
![](assets/chapter-4/loginregister.png)
...
![](assets/chapter-4/registerpack.png)

![](assets/chapter-4/registerpack2.png)

![](assets/chapter-4/merchag.png)
...
![](assets/chapter-4/choosevehicle.png)

![](assets/chapter-4/choosevehicle2.png)
...
![](assets/chapter-4/travel.png)

![](assets/chapter-4/map.png)
...
<tr><td>E2-US013</td><td>Visualización de estadísticas</td><td>T7</td><td><p></p><p>Estadísticas del mes</p></td><td valign="top">Implementar página en la cual se muestren las estadísticas del mes de las empresas de logística </td><td style="text-align: center;">4h</td><td>Astrid Boronda</td><td style="text-align: center;">Done</td></tr>
...
<tr><td>E2-US11</td><td>Gestión de Vehículos</td><td>T9</td><td>Gestión de Vehículos</td><td valign="top">Implementar una tabla que muestre los detalles de cada vehículos y poder editarlos</td><td style="text-align: center;">4h</td><td>Renzo Silva</td><td style="text-align: center;">Done</td></tr>
</table>

<div id='5.2.2.3.'><h5> 5.2.2.3.  Development Evidence for Sprint Review</h5></div>

<div align=justify>
En esta sección, se muestran los commits que se realizaron dentro del repositorio correspondiente al fronted en el Github. Este registro da a conocer el progreso de la contrucción de la aplicación que se tuvo dentro del Sprint 2. Cada commit registra los cambios que fueron aplicados de cualquier versión con fecha anteriores y así, tener el estado del proyecto en un punto exacto.

**Enlace del GitHub:** [https://github.com/upc-pre-202402-si729-sw57-dynoware/CargoSafe-Frontend](https://github.com/upc-pre-202402-si729-sw57-dynoware/CargoSafe-Frontend)
...
![image](assets/chapter-5/TrelloSprintBacklog3.png)
...
<tr><td rowspan="2">E3-US20</td><td rowspan="2">Visualización de gastos incurridos por viaje</td><td>T1</td><td>Visualizar gastos por solicitud</td><td>Desarrollar vista para ver los gastos con cada solicitud de viaje</td><td>4h</td><td>Ely Cortez</td><td>Done</td></tr>
<tr><td>T2</td><td> Relacionar el gasto calculado con el viaje a solicitar</td><td>Implementar lógica para asignar los gastos a los viajes</td><td>4h</td><td>Ely Cortez</td><td>Done</td></tr>
<tr><td>E4-US22</td><td>Registro de cuenta</td><td>T3</td><td>Registro de cuenta</td><td valign="top"><p></p><p>Desarrollar un formulario de registro de cuenta y se almacene correctamente</p></td><td>5h</td><td>Ely Cortez</td><td>Done</td></tr>
<tr><td>E4-US021</td><td>Inicio de sesión</td><td>T4</td><td>Inicio de sesión</td><td valign="top">Desarrollar un formulario de inicio de sesión e implementar la autenticación de usuarios</td><td>5h</td><td>Alexandra Ramos</td><td>Done</td></tr>
<tr><td>E4-US24</td><td>Recuperación de contraseña</td><td>T5</td><td>Recuperación de contraseña</td><td valign="top">Diseñar un formulario para la recuperación de contraseña</td><td>4h</td><td>Alexandra Ramos</td><td>Done</td></tr>
<tr><td>E4-US25</td><td>Cerrar sesión</td><td>T6</td><td>Cerrar sesión</td><td valign="top"><p>Implementar la funcionalidad de cerrar sesión</p></td><td>4h</td><td> Astrid Boronda</td><td>Done</td></tr>
<tr><td>E2-US10</td><td>Registro de rutas</td><td>T7</td><td><p></p><p>Almacenamiento de rutas registradas</p></td><td valign="top">Implementar un sistema de almacenamiento para rutas registradas</td><td>5h</td><td>Carlos León</td><td>Done</td></tr>
<tr><td rowspan="2">E2-US07</td><td rowspan="2">Monitoreo en tiempo real de cargas</td><td>T8</td><td>Visualizar el seguimiento de la carga</td><td>Diseñar una interfaz de usuario para el seguimiento de cargas</td><td>5h</td><td>Renzo Silva</td><td>Done</td></tr>
<tr><td>T9</td><td>Lograr el seguimiento de la carga</td><td>Implementar funcionalidad de rastreo</td><td>5h</td><td>Renzo Silva</td><td>Done</td></tr>
<tr><td>E3-US 18</td><td>Elegir transportista</td><td>T10</td><td>Mostrar a los transportistas</td><td valign="top"><p>Implementar y mostrar una lista de transportistas para seleccionar</p></td><td>5h</td><td>Carlos León</td><td>Done</td></tr>
<tr><td>E2-US11</td><td>Gestión de Vehículos</td><td>T11</td><td>Desarrollo de un API endpoint perteneciente a vehículos</td><td valign="top">Implementar el endpoint para gestionar la información de los vehículos</td><td>5h</td><td>Alexandra Ramos</td><td>Done</td></tr>
<tr><td>E5-US27</td><td>Agregar conductor</td><td>T12</td><td>Desarrollo de un API endpoint perteneciente a conductores</td><td valign="top"><p> Implementar el endpoint para gestionar la información de los conductores</p></td><td>4h</td><td>Alexandra Ramos</td><td>Done</td></tr>
<tr><td>E5-US28</td><td>Agregar viaje en curso</td><td>T13</td><td>Desarrollo de un API endpoint perteneciente a viajes en curso</td><td valign="top">Implementar el endpoint para gestionar la información de los viajes en curso</td><td>4h</td><td>Renzo Silva</td><td>Done</td></tr>
<tr><td rowspan="4">E5-US29</td><td rowspan="4">Gestionar viajes</td><td>T14</td><td>Desarrollo de un API endpoint perteneciente a gastos</td><td valign="top">Implementar el endpoint para mostrar la información de los gastos del viaje</td><td>4h</td><td>Astrid Boronda</td><td>Done</td></tr>
<tr><td>T15</td><td>Desarrollo de un API endpoint perteneciente a alertas</td><td>Implementar el endpoint para mostrar la información de una alerta en relación al viaje</td><td>4h</td><td>Astrid Boronda</td><td>Done</td></tr>
<tr><td>T16</td><td>Desarrollo de un API endpoint perteneciente a evidencias</td><td>Implementar el endpoint para gestionar la información de las evidencias</td><td>4h</td><td>Renzo Silva</td><td>Done</td></tr>
<tr><td>T17</td><td>Desarrollo de un API endpoint perteneciente a las empresas</td><td>Implementar el endpoint para gestionar la información de las empresas</td><td>4h</td><td>Carlos León</td><td>Done</td></tr>
<tr><td>E5-US32</td><td>Gestionar tarjetas de pago</td><td>T18</td><td>Desarrollo de un API endpoint perteneciente a los pagos</td><td valign="top">Implementar el endpoint para  gestionar la información de los pagos realizados para el viaje</td><td>4h</td><td>Carlos León</td><td>Done</td></tr>
<tr><td>E1-US07</td><td>Secciones Sobre el Producto y el Equipo</td><td>T19</td><td>Agregar videos a la landing page</td><td valign="top">Implementar la sección Product and About the Team</td><td>4h</td><td>Ely Cortez</td><td>Done</td></tr>
</table>

Link: [https://trello.com/invite/b/6710221264cb421ef9e8ad88/ATTI0349b692821427e994d96afb6ef91543E0B6E8AF/sprint-backlog-3](https://trello.com/invite/b/6710221264cb421ef9e8ad88/ATTI0349b692821427e994d96afb6ef91543E0B6E8AF/sprint-backlog-3)
...
![image](assets/chapter-5/about_the_product_v1.png)
...
- **Link del video de exposición del TF:** [https://upcedupe-my.sharepoint.com/:v:/g/personal/u202215313_upc_edu_pe/EXQzbf9PvJ1MqPcMAv_jolMBERKQIqlk5xq3GyKSr1oUSA?e=Y5wjj3&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D](https://upcedupe-my.sharepoint.com/:v:/g/personal/u202215313_upc_edu_pe/EXQzbf9PvJ1MqPcMAv_jolMBERKQIqlk5xq3GyKSr1oUSA?e=Y5wjj3&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D)
